<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpstudy\PHPTutorial\WWW\fastadmin\public/../application/index\view\index\index.html";i:1529055329;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="https://www.baidu.com" target="_blank"><?php echo __('Dashboard'); ?></a></li>
        ...
        <footer>
            <div class="container">
                <p>&copy; 2018 FastAdmin. All Rights Reserved.</p>
